    ...
    <div className="main-container">
      <div className="main-content">
        ...
        <p>
          ...
          anyone decided to use our services, <span>metarules.tech</span>{" "}
          website.
        </p>
        <p>
          If you choose to use our services, then you agree to the collection
        ...
        <h3>
          ...
          <span role="img" aria-labelledby="Thanking emoji">
            😊
          </span>
        </h3>
      </div>
